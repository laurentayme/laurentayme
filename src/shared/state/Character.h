...
namespace state {
  ...
  public:
    ...
    int getMaxStat (int stat) const;
    void setMaxStat (int stat, int stat_value);
    // Setters and Getters
    ...
    const std::vector<int>& getMaxStats() const;
    void setMaxStats(const std::vector<int>& MaxStats);
  };
